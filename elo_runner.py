...
def run_elo_for_sport(event_root_path: str, elo_root_path: str, sport: ESPNSportTypes):
    """
    ...
    for season in seasons:
        if (season == 2005 and sport == ESPNSportTypes.NHL) or (season == 2024 and sport == ESPNSportTypes.PLL):
            continue
